...
<div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper widgetpage">
						...
						<p>
                        	<label>Packages:</label>&nbsp;<label class="value"><?php echo $billingrequestview[0]['package']?></label><!-- <a class="editbtn" href="#">Edit</a> -->
                        </p>
