...
<div class="centercontent">
        ...
        <p>
						...
						<!-- <p>
                        	<label>Memory</label>&nbsp;<label class="value"><?php echo $requestView[0]['Memory'];?></label><a class="btn" href="#"></a>
                        </p>

						<p>
                        	<label>Memory Quantity:</label>&nbsp;<label class="value"><?php echo $requestView[0]['ram_quantity'];?></label><a class="btn" href="#"></a>
                        </p>-->
