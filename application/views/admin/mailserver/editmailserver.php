...
<div class="centercontent">
        ...
        <div class="pageheader">
            ...
            <ul class="hornav">
                <li><a href="#activities">Edit Mailserver</a></li>
		...
		<div id="activities" class="subcontent" style="display:block;">
            	<form id="form1" class="stdform stdform2" method="post" action="<?php echo base_url();?>admin/mailserver/edit_mailserver/<?php echo $Details[0]['id'];?>">
                    	<p>
