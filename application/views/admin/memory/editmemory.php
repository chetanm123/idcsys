...
<div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">Sales Plans ><a class="pagetitle listingplan" href="<?php echo base_url();?>admin/memory">Mail Servers</a></h1>
            <span class="pagedesc">This is a sample description of a page</span>
            
            <ul class="hornav">
                <li><a href="#activities">Edit Memory Plan</a></li>
		...
		<div id="activities" class="subcontent" style="display:block;">
            	<form id="form1" class="stdform stdform2" method="post" action="<?php echo base_url();?>admin/memory/edit_memory/<?php echo $Details[0]['id'];?>">
                    	<p>
                        	<label>Memory Plan Name</label>
