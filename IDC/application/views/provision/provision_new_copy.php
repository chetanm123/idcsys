            ...
            <h4>Step 1: Basic Information</h4>
                        ...
                        <div id="step-3" class="formwiz">
							...
							<p>
                                    ...
                                    <span class="field"><input type="password" name="prtg_password" id="prtg_password" class="mediuminput required" /></span>
							...
							<p>
                                    ...
                                    <span class="field"><input type="password" name="fc_password" id="fc_password" class="mediuminput required" /></span>
							...
							<p>
								...
								<p>
                                    ...
                                    <span class="field"><input type="password" name="server_password" id="server_password" class="mediuminput required" /></span>
