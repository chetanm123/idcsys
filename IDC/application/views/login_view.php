...
<script type="text/javascript" src="<?php echo base_url();?>public/js/custom/index.js"></script>
<!--[if IE 9]>
...
<body class="loginpage">
	...
	<div class="loginbox">
    	<div class="loginboxinner">
            ...
            <div class="loginmsg"><?php echo $this->session->userdata('invalid');$this->session->unset_userdata('invalid');?></div>
			<?php } ?>
            ...
            <form id="login" action="login	" method="post">
            	<input type='hidden' name='randval' id='randval' value='<?php echo rand();?>'>
                <div class="username">
