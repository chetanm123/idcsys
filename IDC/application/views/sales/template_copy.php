...
<script src="/public/css/datepicker/jquery-1.9.1.js"></script>
<script src="/public/css/datepicker/jquery-ui.js"></script>
...
<div class="bodywrapper">
	...
	<div class="header">
    	<ul class="headermenu">
        	<li class="current"><a href="<?php echo base_url();?>sales"><span class="icon icon-flatscreen"></span>Dashboard</a></li>
        	...
        	<li><a href="#formsub" class="editor">Requests</a>
            	...
            	<ul id="formsub">
					...
					<li><a href="<?php echo base_url();?>sales/sales/active_sales">Active</a></li>
               		<li><a href="<?php echo base_url();?>sales/sales/previous_sales">Previous</a></li>
