...
<div class="vernav2 iconmenu">
    	<ul>
        	<li><a href="#formsub" class="editor">Requests</a>
            	...
            	<ul id="formsub">
					<li><a href="<?php echo base_url();?>provision/provisions">Active</a></li>
               		<li><a href="<?php echo base_url();?>provision/provisions/provisioned">Request Provisioned</a></li>
                    </ul>
            </li>
			<li><a href="<?php echo base_url();?>provision/provisions/provisioned" class="gallery">Provisions</a></li>
