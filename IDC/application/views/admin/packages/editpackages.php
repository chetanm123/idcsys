...
<div class="centercontent">
        ...
        <div class="pageheader">
            ...
            <ul class="hornav">
                <li><a href="#activities">Edit Packages</a></li>
		...
		<div id="activities" class="subcontent" style="display:block;">
            	<form id="form1" class="stdform stdform2" method="post" action="<?php echo base_url();?>admin/packages/edit_packages/<?php echo $Details[0]['id'];?>">
                    	<p>
