                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
					...
					{?>
						...
						{?>
							<tr class="gradeX">
							<td>							
							<a href="<?php echo base_url();?>billing/billing/create_billing/<?php echo $list['id'];?>">Bill</a>							
							</td>
							...
							<!-- <td><a href="#">Edit</a></td> -->
							 <td><a href="<?php echo base_url();?>billing/billing/salesrequestview/<?php echo $list['id'];?>">SReq:#<?php  echo $list['id'];?></a><br/><a href="<?php echo base_url();?>billing/billing/provisionrequestview/<?php echo $list['provisionid'];?>">Prov:#<?php  echo $list['provisionid'];?></a><br/></td>
							 </tr>
                        <?php 
						}  
					}
					...
					?>
					<tr class="gradeX">
					   <td colspan="6" align="center" style="font-weight:bold;font-size:15px;" valign="middle">No Active Sales Request To Bill</td>
					</tr>
					<?php
					}
					?>
